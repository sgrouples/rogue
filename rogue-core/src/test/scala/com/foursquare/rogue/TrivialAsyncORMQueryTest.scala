...
import com.foursquare.rogue.MongoHelpers.{AndCondition, MongoSelect}
import com.mongodb._
import com.mongodb.async.client.{MongoCollection, MongoDatabase, MongoClients}
...
object TrivialAsyncORM {
  ...
  type MB = Meta[_]
  class MyDBCollectionFactory(dba: MongoDatabase) extends AsyncDBCollectionFactory[MB] {
